 ...
 */
package com.mycompany.geography.Controller;

import com.mycompany.geography.Common.Library;
import com.mycompany.geography.Model.Country;
import com.mycompany.geography.View.Menu;
import java.util.ArrayList;
import java.util.Collections;

public class GeographyManager extends Menu<String>{
